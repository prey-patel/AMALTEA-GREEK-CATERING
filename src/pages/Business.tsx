...
export default function Business({ lang, setActiveTab, t, pageHeroData, categories, onOpenMenuPdf }: BusinessProps) {
  ...
  const heroBgImage = getOptimizedImageUrl(pageHeroData?.image_url || "https://images.unsplash.com/photo-1511578314322-379afb476865?auto=format&fit=crop&q=70&w=1200", 1200);
  ...
  const items = categories && categories.length > 0 
    ...
    : [
        {
          title: t('businessCat1Title'),
          desc: t('businessCat1Desc'),
          Icon: Briefcase,
        },
        {
          title: t('businessCat2Title'),
          desc: t('businessCat2Desc'),
          Icon: Award,
        },
        {
          title: t('businessCat3Title'),
          desc: t('businessCat3Desc'),
          Icon: Users,
        },
        {
          title: t('businessCat4Title'),
          desc: t('businessCat4Desc'),
          Icon: Utensils,
        },
      ];
  ...
  return (
    <div className="space-y-20 pb-20 overflow-hidden bg-slate-50/50 dark:bg-brand-bg/30">
      ...
      {/* Grid layout of Business Services */}
